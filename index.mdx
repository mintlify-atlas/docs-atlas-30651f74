...
<CardGroup cols={2}>
  <Card title="Custom Dimensions" icon="globe" href="/concepts/dimensions">
  ...
  <Card title="Advanced Biome System" icon="mountain" href="/concepts/biomes">
  ...
  <Card title="Performance Optimized" icon="gauge-high" href="/configuration">
  ...
  <Card title="Pregeneration System" icon="layer-group" href="/generation/pregeneration">
  ...
  <Card title="IrisToolbelt API" icon="toolbox" href="/api/toolbelt">
